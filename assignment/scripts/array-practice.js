...
let favoriteFoods = ["watermelon", "cantaloupe", "grapes", "cheeseburger", "beef stroganoff"];
...
console.log( "Favorite foods with an entree added to the beginning", favoriteFoods );
...
console.log( "Colors after lastColor was removed:", colors );
console.log( "The removed color was", lastColor );
...
console.log( "Colors after firstColor was removed", colors );
console.log( "the color removed from the first postition was", firstColor );
...
for (let i = gems.length; i > 0; i--) {
  revSortGems.push(sortedGems[i - 1]);
  gems = revSortGems;
}
console.log( gems);
...
let gemString = revSortGems.join(" and ");
